                                ...
                                af: {
                                    ...
                                    search_kw: function () {
                                        ...
                                        function _search() {
                                            ...
                                            setText(_text);
                                            waitForAction(() => $$sel.pickup(_text), 3000, 80);
            ...
            return {
                ...
                queue: function () {
                    ...
                    while ((_que_len = this.excl_tasks_len)) {
                        ...
                        if (timeRecorder("sc_q", "L", 60000) >= _max_que_t) {
        ...
        function _fgAppBlistSetter() {
            return {
                ...
                autoDelay: function () {
                    ...
                    sleep(10 * 1000); // in case task isn't set successfully before exit;
                ...
                prompt: () => {
                    ...
                    function actionSetter() {
                        return {
                            ...
                            wait: function () {
                                let _this = this;
                                if (!waitForAction(() => _this._sgn_move_on, 60000)) {
                                    _diag.dismiss();
                    ...
                    function maskLayerSetter() {
                        ...
                        let _o = {
                            ...
                            enforce: function () {
                                ...
                                let _cC1 = () => waitForAction(() => !_o.smp.trig(), 2000, 80);
