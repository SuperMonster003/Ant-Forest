module.exports = {
    dialog_contents: {
        ...
        balls_click_interval: // 能量球点击间隔
            ...
            "设置过小值可能遗漏点击能量球\n" +
            "设置过大值将影响快速收取体验",
        homepage_wball_max_hue_b0: // 金色球最大色相值 (无蓝分量)
            "用以判断能量球是否为浇水能量球\n" +
            "即金色能量球\n" +
            "判断及计算方法:\n" +
            "区域中心横向 70% 线性扫描\n" +
        ...
        forest_balls_pool_itv: // 能量球样本采集间隔
            ...
            "间隔过小将导致样本差异过小\n" +
            "影响识别率并出现遗漏或误判",
        forest_balls_recog_region: // 森林页面能量球识别区域
            "用于限制森林页面能量球的识别区域\n" +
            "识别的能量球必须全部包含在此区域\n" +
            "才被视为有效的能量球样本\n\n" +
            "需填写 4 个参数并以逗号分隔\n" +
        ...
        help_collect_icon_threshold: // 帮收图标颜色检测阈值
            ...
            "阈值越大 匹配越宽松 反之越严格\n" +
            "0 表示完全相似",
        help_ball_detect_color_val: // 帮收能量球颜色色值
            "森林页面识别橙色能量球的参照色值\n\n" +
            "示例:\n" +
            "rgb(67,160,71)\n" +
            "#43a047",
        help_ball_detect_threshold: // 帮收能量球颜色检测阈值
            "森林页面识别橙色能量球的\n" +
            "参照色值检测阈值\n" +
            "阈值越大 匹配越宽松 反之越严格",
