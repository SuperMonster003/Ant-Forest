module.exports = {
    ...
    image_base64_data: {
        outlook_icon: getBase64OutlookIcon(),
        qq_icon: getBase64QqIcon(),
        github_icon: getBase64GithubIcon(),
        detective_avatar: getBase64DetectiveAvatarIcon(),
        alipay_donation_qr_code: getBase64AlipayDonationQrCode(),
        wechat_donation_qr_code: getBase64WechatDonationQrCode(),
    },
};

// base64 function(s) //

function getBase64OutlookIcon() {
...
function getBase64DetectiveAvatarIcon() {
...
function getBase64AlipayDonationQrCode() {
...
function getBase64WechatDonationQrCode() {
