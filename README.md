...
当前分支 (Ant_Forest) 仅用作1.x版本历史备份及遗留链接保活  
后续项目更新请访问 [master](https://github.com/SuperMonster003/Ant-Forest/tree/master) 分支 (当前分支将不再更新)  
使用说明及功能简介等亦请访问 [master](https://github.com/SuperMonster003/Ant-Forest/tree/master) 分支查看

******
### 版本历史
******
# v2.0.0
###### 2021/02/11 - 按步骤说明完成升级
* `1` 运行"配置工具"点击"立即更新"下载项目
* `2` 退出当前"配置工具"
* `3` 运行"Ant_Forest_Launcher"
* `4` 按提示完成2.x版本的项目部署
...
* `优化` 独立解锁模块 (./Modules/MODULE_UNLOCK.js) _[`issue #3`](https://github.com/SuperMonster003/Ant-Forest/issues/3)_ _[`#28`](https://github.com/SuperMonster003/Ant-Forest/issues/28)_
