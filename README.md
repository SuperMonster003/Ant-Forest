...
> > [项目文档](https://github.com/SuperMonster003/Auto.js_Projects/wiki/%E8%9A%82%E8%9A%81%E6%A3%AE%E6%9E%97-(Ant-Forest)) (图文)
>
> ###### 系统需求
>
> > Android 版本: `7.0+`  
...
* `优化` 连续运行时通过广播传递初始屏幕开关状态避免不必要的中途关屏
